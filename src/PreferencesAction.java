...
public class PreferencesAction extends ActionClass {
    private PreferencesPane preferencesPane;
    private MainWindow mainWindow;
    private static ImageIcon icon = new ImageIcon(ResourceLoader.getUrl("images/preferences.png"));

    public PreferencesAction(MainWindow mainWindow) {
        super(ResourceLoader._("Preferences ..."), -1, icon); 
